...
const LibraryFolderCard = ({
  ...
  refetchChildFolders: (
    info?: unknown,
  ) => OsFolder[] | Promise<OsFolder[] | null | undefined> | null | undefined;
  ...
  return (
    <>
      ...
      {/* > */}
      <ContextMenu>
        <ContextMenuTrigger class="w-full flex justify-center items-center will-change-auto">
          <div
            class={cn(
          ...
          >
            ...
            <Show when={folder.cover_img_path}>
              <img
                src={
                  folder.cover_img_path && convertFileSrc(folder.cover_img_path)
                }
                class={cn(
            ...
            <MangafolderTitleBar index={index} folder={() => folder} />
            ...
            <Show when={folder.is_read && !folder.is_hidden}>
              <IconBookFilled
                class="h-[30%] w-fit
								...
								duration-200 fill-secondary dark:fill-secondary-foreground"
              />
            </Show>
          </div>
        </ContextMenuTrigger>
